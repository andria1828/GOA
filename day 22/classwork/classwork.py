...
def is_prime(number):
    # 1-ს გამორჩევას არის მარტივი რიცხვი
    if number <= 1:
        return False
    
    # 2-ს და 3-ს გამორჩევას არის მარტივი რიცხვი
    if number <= 3:
        return True
    
    # შევამოწმოთ თუ number-ის არის ლუწი რიცხვი ან არა
    if number % 2 == 0 or number % 3 == 0:
        return False
    
    # შევამოწმოთ უნდა თუ არა number-ის მარტივობა
    i = 5
    while i * i <= number:
...
print(f"რიცხვების ჯამი: {result}")  # შედეგი: 15
...
def count_vowels(string):
    # ყოველი ხმოვანი ასო
    vowels = "aeiouAEIOU"
    # სტრიქონის შექმნა ლექსიკონში, რომლითაც ხმვალია   
